...
my $help              = 0;
my $host              = undef;
my $port              = $ENV{LOCALLIBAPP_PORT} || $ENV{CATALYST_PORT} || 3000;
my $keepalive         = 0;
my $restart           = $ENV{LOCALLIBAPP_RELOAD} || $ENV{CATALYST_RELOAD} || 0;
my $background        = 0;
my $pidfile           = undef;
...
locallibapp_server.pl - Catalyst Testserver

=head1 SYNOPSIS

locallibapp_server.pl [options]
